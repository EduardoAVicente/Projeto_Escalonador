...
public class Prioridade extends SwingWorker<List<Processo>, String> {
    ...
    protected List<Processo> doInBackground() throws Exception {
         ...
         // logs iniciais
         log.write("***********************************");
         log.write("***** ESCALONADOR PRIORIDADE ******");
         log.write("-----------------------------------");
         ...
         while (cpu != null) {
             ...
             if (fila.estaOrdenadaIO() == false) {
                 fila.ordenarIO();
                 log.write("#[evento] FILA REORGANIZADA");
             }
    ...
    protected void process(List<String> chunks) {
        for (String message : chunks) {
            // Atualize a interface do usuário aqui com as mensagens
        }
    }
